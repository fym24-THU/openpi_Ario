...
echo "=== Step 1: Computing norm stats (small dataset) ==="
python scripts/compute_norm_stats.py --config-name pi05_xingchen_fold_ario_debug

echo "=== Step 2: Training (500 steps, batch_size=8) ==="
python scripts/train.py pi05_xingchen_fold_ario_debug
